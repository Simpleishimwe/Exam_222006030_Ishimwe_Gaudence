...
public class exam extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Connection con=DriverManager.getConnection("jdbc:mysql://localhost/manage","root","");
        PreparedStatement ps=con.prepareStatement("insert into studs(name,age,gender)values(?,?,?)");
        ps.setString(1,name);
        ps.setString(2,age);
    ...
    try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/manage","root","");
            PreparedStatement ps=con.prepareStatement("Update studs set name=?,age=?,gender=? where id=?");
            ps.setString(1, name);
            ps.setString(2, age);
           if(jRadioButton1.isSelected())
           {
    ...
    try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/manage","root","");
            PreparedStatement ps=con.prepareStatement("Delete from studs where id=?");
